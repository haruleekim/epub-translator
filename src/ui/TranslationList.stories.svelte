<script lang="ts" module>
    ...
    composer.addTranslation(new Partition(new NodeId([2, 1, 2])), `<p>C'est mon livre.</p>`);

    composer.addTranslation(new Partition(new NodeId([2, 1, 1, 0])), "Bonjour monde!");
